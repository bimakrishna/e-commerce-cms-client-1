  ...
  <div class="main">
    <div class="main-web">
      <div v-if="navOpen" class="main-nav col-1.5">
        ...
        <div class="space products-space">
          <h3><a href="#"><b>Products</b></a></h3>
      ...
      <div class="main-content col-14">
        <div class="content-nav">
          ...
          <div class="user-email">Products</div>
  ...
  methods: {
    ...
    addProduct () {
      ...
      `,
          ...
          .then((result) => {
            if (result.isConfirmed) {
              this.addProductPayload.name = result.value
              this.$store.dispatch('addProduct', this.addProductPayload)
            }
          })
          .catch((err) => {
            console.log(err)
